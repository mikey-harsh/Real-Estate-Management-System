...
function NotFoundPage() {
  return (
    <PageTransition className="min-h-screen flex flex-col items-center justify-center bg-[#FAF8F4]">
      <h1 className="font-fraunces text-6xl font-bold text-[#2563EB] mb-4">404</h1>
      <p className="font-manrope text-xl text-[#374151] mb-8">Page not found</p>
      <a href="/" className="bg-[#2563EB] text-white font-manrope font-bold px-8 py-3 rounded-lg hover:bg-[#1D4ED8] transition-all">
        Go Home
      </a>
    </PageTransition>
  );
    ...
    <>
      ...
      <AnimatePresence mode="wait">
        <Routes location={location} key={location.pathname}>
          ...
          <Route path="/seller/requests" element={<PageTransition><SellerOrdersPage /></PageTransition>} />
