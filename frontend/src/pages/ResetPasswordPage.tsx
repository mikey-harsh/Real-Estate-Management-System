        ...
        <div className="bg-white border border-[#E6E0DA] rounded-2xl p-8 shadow-xl">
          {isSuccess ? (
            ...
            <div className="text-center py-4">
              ...
              <Link
                to="/signin"
                className="w-full inline-block bg-[#2563EB] text-white font-manrope font-bold py-3 rounded-xl hover:bg-[#1E40AF] transition-all text-center"
              >
                Sign In Now
              </Link>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#F5F1E8] border border-[#EBE5DE] rounded-xl pl-12 pr-12 py-3.5 font-manrope text-sm text-[#221410] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB] transition-all"
                      required
                    />
                    <button
                      type="button"
