    ...
    return (
      <div className="min-h-screen bg-[#FAF8F4]">
        ...
        <div className="max-w-xl mx-auto px-4 py-24 text-center">
          ...
          <Link
            to="/add-property"
            className="inline-block bg-[#2563EB] text-white font-manrope font-semibold px-8 py-3 rounded-xl hover:bg-[#1D4ED8] transition-colors"
          >
            + List a Property
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-[#FAF8F4]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <Link
            to="/add-property"
            className="inline-flex items-center gap-2 bg-[#2563EB] text-white font-manrope font-semibold px-5 py-2.5 rounded-xl hover:bg-[#1D4ED8] transition-colors self-start sm:self-auto"
          >
                ...
                <div className="flex-1 p-5 flex flex-col justify-between gap-3">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3 font-manrope text-sm text-[#374151]">
                      <span className="font-semibold text-[#2563EB]">{formatPrice(listing.price)}</span>
                      <span>·</span>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {listing.status === 'active' && (
                        <Link
                          ...
                          className="font-manrope text-xs font-medium text-[#2563EB] hover:underline"
                          target="_blank"
                      ...
                      <Link
                        ...
                        className="flex items-center gap-1.5 font-manrope text-xs font-semibold text-[#374151] border border-[#E6E0DA] px-3 py-1.5 rounded-lg hover:border-[#2563EB] hover:text-[#2563EB] transition-colors"
                      >
