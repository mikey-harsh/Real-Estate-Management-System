...
const AIHubProductionPage: React.FC = () => {
  ...
  const steps = [
    { step: '01', title: 'Clone the Repository', command: 'git clone <your-repository-url>.git' },
        ...
        <div className="max-w-[1280px] mx-auto px-8 pt-32 pb-20 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-3 bg-[rgba(212,117,91,0.15)] border border-[rgba(212,117,91,0.3)] rounded-full px-5 py-2.5 mb-8">
              <span className="font-material-icons text-[#2563EB] text-lg">smart_toy</span>
              <span className="font-manrope font-bold text-sm text-[#2563EB] uppercase tracking-wider">
                AI-Powered Feature
              </span>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <a
                ...
                className="bg-[#2563EB] text-white font-manrope font-bold text-lg px-8 py-4 rounded-xl shadow-lg hover:bg-[#1D4ED8] transition-all hover:shadow-xl inline-flex items-center gap-3"
              >
              ...
              <Link
                to="/properties"
                className="border-2 border-[rgba(255,255,255,0.2)] text-white font-manrope font-bold text-lg px-8 py-4 rounded-xl hover:border-[#2563EB] hover:text-[#2563EB] transition-all inline-flex items-center gap-2"
              >
                Browse Properties
            ...
            <div className="bg-[rgba(212,117,91,0.1)] border border-[rgba(212,117,91,0.25)] rounded-2xl p-6 max-w-xl mx-auto">
              <div className="flex items-start gap-3">
                <span className="font-material-icons text-[#2563EB] text-xl mt-0.5">info</span>
      ...
      <section className="max-w-[1280px] mx-auto px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white border border-[#E6D5C3] rounded-2xl p-6 hover:shadow-lg hover:border-[#2563EB]/30 transition-all group"
            >
              <div className="w-12 h-12 bg-[rgba(212,117,91,0.1)] rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#2563EB] transition-colors">
                <span className="font-material-icons text-[#2563EB] group-hover:text-white transition-colors">
                  {feature.icon}
                </span>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((item) => (
              <div key={item.step} className="bg-white rounded-2xl p-6 border border-[#E6D5C3]">
                <span className="font-space-mono text-4xl font-bold text-[#2563EB]/20 block mb-3">
                  {item.step}
                </span>
                <h3 className="font-syne font-bold text-lg text-[#111827] mb-3">{item.title}</h3>
                <code className="block bg-[#221410] text-[#2563EB] font-space-mono text-xs rounded-lg p-3 overflow-x-auto">
                  {item.command}
                </code>
              </div>
            ))}
...
const AIHubDevPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#FAF8F4] min-h-screen">
      ...
      {/* Hero — search form */}
      {AIHeroSection && (
        <React.Suspense fallback={<div className="h-96 flex items-center justify-center"><div className="w-12 h-12 border-4 border-[#2563EB] border-t-transparent rounded-full animate-spin" /></div>}>
          <AIHeroSection
            ...
            <section className="bg-[#FAF8F4] py-10 border-t border-[#E6E0DA]">
              <div className="max-w-[1200px] mx-auto px-6 text-center">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-[#2563EB] hover:bg-[#1E40AF] text-white font-manrope font-semibold text-sm px-6 py-3 rounded-xl transition-all shadow-md shadow-[#2563EB]/20"
                >
