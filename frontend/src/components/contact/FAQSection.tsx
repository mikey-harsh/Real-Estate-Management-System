...
const FAQSection: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "We currently cover major metropolitan areas including Bengaluru, Mumbai, Delhi, Hyderabad, and Pune. We're expanding to more cities across India and will update our coverage area regularly."
    },
    {
      id: 3,
      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="text-center mb-16">
          <div className="flex justify-center mb-3">
            <span className="font-space-mono text-xs text-[#2563EB] uppercase tracking-widest">
              Help Center
            </span>
          </div>
            ...
            >
              ...
              >
                ...
                <div className="w-8 h-8 bg-[#F9F7F2] border border-[#E6E0DA] rounded-full flex items-center justify-center flex-shrink-0">
                  <span className="font-syne font-bold text-sm text-[#2563EB]">
                ...
                <span className={`material-icons text-[#2563EB] transition-transform ${
        ...
        <div className="text-center mt-12">
          <a 
            href="#" 
            className="inline-flex items-center gap-2 font-manrope font-bold text-base text-[#2563EB] hover:text-[#1E40AF] transition-colors group"
          >
