          ...
          {methods.map((method, index) => (
            ...
            >
              ...
              <div className={`w-16 h-16 ${method.bgColor} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                <span className="material-icons text-3xl text-[#2563EB]">
                  {method.icon}
                </span>
              </div>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 font-manrope font-bold text-sm text-[#2563EB] hover:text-[#1E40AF] transition-colors group"
              >
