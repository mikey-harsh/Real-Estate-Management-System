      ...
      <div className="p-6">
        ...
        <div className="mb-8 border-b border-[#F5F1E8] pb-8">
          ...
          <div className="relative mb-3">
            ...
            <input
              ...
              className="w-full bg-[#F5F1E8] border border-[#EBE5DE] rounded-lg pl-10 pr-4 py-3 font-manrope text-sm text-[#111827] placeholder:text-[#6B7280] focus:outline-none focus:border-[#2563EB] transition-all"
            />
          </div>
        </div>
              ...
              <button
                ...
                className={`flex-1 h-11 rounded-xl border font-manrope font-bold text-sm transition-all ${
                  selectedAvailability === avail.id
                    ...
                    : 'bg-white border-[#E6E0DA] text-[#6B7280] hover:border-[#2563EB] hover:text-[#2563EB]'
                }`}
              >
                {avail.label}
              </button>
        ...
        <div className="mb-8 border-b border-[#F5F1E8] pb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="font-space-mono text-sm text-[#2563EB]">
          ...
          <div className="relative mb-4 px-2">
            <input
              ...
              className="w-full h-1.5 bg-[#E6E0DA] rounded-full appearance-none cursor-pointer accent-[#2563EB]"
            />
          </div>
              ...
              <button
                ...
                className={`flex-1 h-10 rounded-lg font-manrope font-bold text-sm border transition-all ${
                  bedrooms === num
                    ...
                    : 'bg-white border-[#E6E0DA] text-[#6B7280] hover:border-[#2563EB]'
                }`}
              >
              ...
              <label 
                ...
                className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                  selectedAmenities.includes(amenity)
                    ? 'bg-[rgba(212,117,91,0.05)] border-[#2563EB]'
                    : 'bg-white border-[#E6E0DA] hover:border-[#2563EB]'
                }`}
              >
                ...
                <span className={`font-manrope text-sm ${
                   selectedAmenities.includes(amenity) ? 'text-[#2563EB] font-semibold' : 'text-[#4B5563]'
                }`}>
                  {amenity}
                </span>
              </label>
        ...
        <button
          onClick={handleReset}
          className="w-full bg-white border border-[#2563EB] text-[#2563EB] font-manrope font-bold text-base py-4 rounded-xl transition-all hover:bg-[#2563EB] hover:text-white sticky bottom-0"
        >
          Reset Filters
        </button>
      </div>
