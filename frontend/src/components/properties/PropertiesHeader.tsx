          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-white border border-[#E6E0DA] rounded-lg px-4 py-2 font-manrope text-sm text-[#221410] cursor-pointer focus:outline-none focus:border-[#2563EB] appearance-none pr-8 bg-no-repeat bg-right"
                style={{
