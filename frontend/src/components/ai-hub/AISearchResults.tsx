...
const PropertyCard: React.FC<{
  ...
  return (
    <div className={`bg-white rounded-2xl overflow-hidden hover:shadow-[0_20px_40px_-15px_rgba(212,117,91,0.15)] hover:-translate-y-1 transition-all duration-300 group flex flex-col relative border ${isComparing ? 'border-[#2563EB] ring-2 ring-[#2563EB]/20' : 'border-[#E6E0DA]/60'}`}>
      {/* Accent bar */}
      <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-[#2563EB] to-amber-500 opacity-60 group-hover:opacity-100 transition-opacity" />
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        {/* Building name */}
        <h3 className="font-syne text-[20px] font-bold text-[#221410] mb-1 leading-tight line-clamp-2 group-hover:text-[#2563EB] transition-colors">
        ...
        <div className="flex items-start gap-1.5 mb-4">
          <MapPin className="w-3.5 h-3.5 text-[#2563EB]/60 mt-0.5 shrink-0" />
        ...
        <div className="flex items-center justify-between bg-[#FAF8F4] border border-[#E6E0DA]/50 rounded-xl px-4 py-3 mb-3">
          <div>
            ...
            <p className="font-manrope font-extrabold text-[#2563EB] text-xl leading-none">
        ...
        {insight?.one_line_insight && (
          <div className="bg-[#FAF8F4] border border-[#2563EB]/20 rounded-xl px-4 py-3 mb-3">
            <p className="font-manrope text-[12px] text-[#1E40AF] font-medium leading-snug">
              <span className="font-bold text-[#2563EB]">AI </span>
            ...
            {hasMatchScore && (
              <div className="flex items-center gap-2 mt-2">
                <div className="flex-1 h-1.5 bg-[#E6E0DA] rounded-full overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-[#2563EB] to-amber-400 rounded-full transition-all duration-700"
        ...
        <div className="flex gap-2 mt-4 pt-4 border-t border-[#E6E0DA]/50">
          {property.property_url ? (
            <a
              ...
              className="flex-1 inline-flex items-center justify-center gap-1.5 bg-[#2563EB] hover:bg-[#1E40AF] text-white font-manrope font-semibold text-sm py-2.5 rounded-xl transition-all shadow-sm shadow-[#2563EB]/20"
            >
          ...
          <button
            ...
            className={`px-4 py-2.5 font-manrope font-semibold text-sm rounded-xl transition-all border ${
              isComparing
                ? 'bg-[#2563EB] border-[#2563EB] text-white hover:bg-[#1E40AF]'
                : canCompare
                  ? 'border-[#E6E0DA] text-[#6B7280] hover:border-[#2563EB]/50 hover:text-[#2563EB]'
...
const ComparisonModal: React.FC<{
  ...
  const getCellValue = (property: ScrapedProperty, key: string): React.ReactNode => {
    ...
    switch (key) {
      case 'price':
        return <span className="font-bold text-[#2563EB]">{property.price || '—'}</span>;
      case 'price_per_sqft':
          ...
          {[1, 2, 3, 4].map(i => (
            <div key={i} className="bg-white/60 border border-white rounded-2xl p-6 shadow-sm animate-pulse">
              ...
              <div className="flex gap-2 pt-4 border-t border-[#E6E0DA]/30">
                <div className="flex-1 h-10 bg-[#2563EB]/20 rounded-xl" />
    ...
    <>
      <div>
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <div className="font-space-mono text-[11px] text-[#2563EB] font-bold uppercase tracking-widest mb-2 flex items-center gap-2">
            ...
            <p className="font-manrope text-base text-[#6B7280]">
              ...
              {aiMatchCount > 0 && (
                <> · <strong className="text-[#2563EB]">{aiMatchCount}</strong> with AI insights</>
              )}
            </p>
          </div>
        </div>
          ...
          <div className="max-w-[1200px] mx-auto px-6 py-4 flex items-center gap-4">
              ...
              {compareList.map((p, i) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="shrink-0 text-[#9CA3AF] hover:text-[#2563EB] transition-colors"
                  >
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-[#2563EB] hover:bg-[#1E40AF] text-white font-manrope font-semibold text-sm px-5 py-2.5 rounded-xl transition-all shadow-sm shadow-[#2563EB]/25"
              >
