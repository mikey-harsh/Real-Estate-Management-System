      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        <div className="flex items-center gap-4 mb-10">
          <div className="w-12 h-12 bg-white border border-[#E6E0DA] shadow-sm rounded-full flex items-center justify-center relative">
            <div className="absolute inset-0 bg-[#2563EB]/5 rounded-full" />
            <BarChart3 className="w-5 h-5 text-[#2563EB] relative z-10" />
          </div>
          <div>
                    ...
                    >
                      <td className="px-8 py-5">
                        <div className="flex items-center gap-3">
                          <MapPin className="w-4 h-4 text-[#2563EB]/60 group-hover:text-[#2563EB] transition-colors" />
              ...
              <div className="bg-white border border-[#E6E0DA] shadow-sm rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  {analysis.trends.map((trend, i) => {
                    ...
                    return (
                      <div key={i} className="bg-[#FAF8F4] border border-[#E6E0DA]/60 rounded-xl p-5 hover:border-[#2563EB]/30 transition-colors">
