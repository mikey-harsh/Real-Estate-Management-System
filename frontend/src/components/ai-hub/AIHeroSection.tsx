  ...
  return (
    <section className="relative bg-[#FAF8F4] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        <div className="absolute top-0 inset-x-0 h-[800px] bg-gradient-to-b from-[#2563EB]/10 to-transparent" />
        <div className="absolute top-20 left-10 w-[500px] h-[500px] bg-[#2563EB]/10 rounded-full blur-[100px]" />
      ...
      <div className="relative pt-32 pb-24 max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-white/60 backdrop-blur-sm border border-[#2563EB]/20 rounded-full px-4 py-2 mb-6 shadow-sm">
            <Sparkles className="w-4 h-4 text-[#2563EB]" />
            <span className="font-space-mono text-xs text-[#2563EB] uppercase tracking-wider font-semibold">
              AI-Powered Search
            </span>
          </div>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="relative bg-white border border-[#E6E0DA] rounded-xl p-4 flex items-center gap-3 focus-within:ring-2 focus-within:ring-[#2563EB]/30 focus-within:border-[#2563EB] transition-all shadow-sm">
                ...
                {POPULAR_CITIES.map((c) => (
                  <button
                    ...
                    className={`font-manrope text-xs px-4 py-1.5 rounded-full border transition-all ${city === c
                      ? 'bg-[#2563EB] border-[#2563EB] text-white font-medium shadow-sm'
                      : 'bg-white border-[#E6E0DA] text-[#6B7280] hover:border-[#2563EB]/50 hover:text-[#2563EB]'
                      }`}
                  >
                    {c}
                  </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
              ...
              <div>
                ...
                <div className="relative bg-white border border-[#E6E0DA] rounded-xl p-4 flex items-center gap-3 focus-within:ring-2 focus-within:ring-[#2563EB]/30 focus-within:border-[#2563EB] transition-all shadow-sm">
                  <IndianRupee className="w-5 h-5 text-[#2563EB] shrink-0" />
                  <input
                    type="number"
                    value={maxBudget}
                    ...
                    return (
                      <div key={s.label} className={`flex items-start gap-3 transition-opacity duration-500 ${isPending ? 'opacity-35' : 'opacity-100'}`}>
                        <div className="mt-0.5 shrink-0 w-5 h-5 flex items-center justify-center">
                          ...
                          : isActive ? <Loader2 className="w-5 h-5 text-[#2563EB] animate-spin" />
                          :            <div className="w-4 h-4 rounded-full border-2 border-[#2563EB]/30" />}
                        </div>
                        <div>
