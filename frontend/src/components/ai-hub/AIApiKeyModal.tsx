      ...
      <div className="relative w-full max-w-lg bg-[#1a0f0a] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-[#2563EB]/20 rounded-xl flex items-center justify-center">
        ...
        <div className="flex items-center gap-3 px-6 pb-6">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-[#2563EB] hover:bg-[#1E40AF] disabled:opacity-40 disabled:cursor-not-allowed text-white font-manrope font-semibold text-sm py-3 rounded-xl transition-all"
          >
  ...
  <div>
    <div className="flex items-center justify-between mb-1.5">
      ...
      <a href={linkHref} target="_blank" rel="noopener noreferrer"
        className="flex items-center gap-1 font-manrope text-[11px] text-[#2563EB] hover:text-[#e88a6f] transition-colors">
        {linkText} <ExternalLink className="w-3 h-3" />
      </a>
    </div>
    <div className="relative bg-white/[0.07] border border-white/10 rounded-xl px-4 py-3 flex items-center gap-3 focus-within:border-[#2563EB]/50 transition-all">
      <Key className="w-4 h-4 text-[#2563EB]/60 shrink-0" />
      <input
