    ...
    <section className="bg-[#F2EFE9] py-24">
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <button className="font-space-mono text-sm text-[#221410] border-b border-[#221410] hover:text-[#2563EB] hover:border-[#2563EB] transition-colors pb-1">
            View All → See more
          </button>
        </div>
          ...
          {properties.map((property) => (
            ...
            >
              ...
              <div className="relative aspect-[382/286.5] overflow-hidden">
                ...
                {/* Badge */}
                <div className="absolute top-4 left-4 bg-[#2563EB] text-white font-space-mono text-xs px-3 py-1.5 rounded-full shadow-lg">
                  {property.badge}
                </div>
