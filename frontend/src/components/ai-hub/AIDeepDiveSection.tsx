  ...
  return (
    <section className="bg-white py-24">
      <div className="max-w-[1280px] mx-auto px-8">
        {/* Section Header */}
        <div className="mb-12">
          <div className="font-space-mono text-xs text-[#2563EB] uppercase tracking-[1.2px] mb-4">
            Deep Analysis
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white border border-[#E6E0DA] rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="p-6">
              ...
              <p className="font-space-mono font-bold text-lg text-[#2563EB] mb-4">
                $2,400,000
              </p>
          ...
          <div className="space-y-6">
                ...
                {analysisData.marketScoring.map((item, index) => (
                  <div key={index}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="font-space-mono font-bold text-sm text-[#2563EB]">
                        {item.score}%
                      </span>
                    </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {analysisData.investmentMetrics.map((metric, index) => (
                  <div key={index} className="text-center">
                    <div className="font-space-mono font-bold text-2xl text-[#2563EB] mb-1">
                      {metric.value}
                    </div>
            ...
            <div className="bg-[#2563EB] text-white rounded-xl p-6 flex items-center justify-between">
              <div>
