      ...
      <div className="flex items-center justify-between">
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            onChange={handleInputChange}
            className="w-4 h-4 rounded border-[#E6E0DA] text-[#2563EB] focus:ring-[#2563EB]"
          />
        ...
        <Link
          to="/forgot-password"
          className="font-manrope font-medium text-sm text-[#2563EB] hover:text-[#1E40AF] transition-colors"
        >
          Forgot Password?
        </Link>
      </div>
