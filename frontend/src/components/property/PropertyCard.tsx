  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 cursor-pointer">
      <div className="relative h-64">
        ...
        {featured && (
          <div className="absolute top-4 left-4 bg-[#2563EB] text-white px-3 py-1 rounded-lg font-manrope font-bold text-xs">
            FEATURED
          </div>
        )}
        {aiMatch && (
          <div className="absolute top-4 right-4 bg-[rgba(212,117,91,0.1)] px-2 py-1 rounded">
            <span className="font-manrope font-bold text-xs text-[#2563EB]">AI MATCH: {aiMatch}%</span>
          </div>
        )}
      </div>
      <div className="p-6">
