          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="inline-flex items-center gap-3 bg-[rgba(212,117,91,0.1)] border border-[rgba(212,117,91,0.2)] rounded-full px-4 py-2 mb-10">
                ...
                <span className="font-manrope font-bold text-xs text-[#2563EB] uppercase tracking-wider">
              ...
              <motion.h1 variants={itemVariants} className="font-fraunces text-[56px] lg:text-[70px] leading-[1.1] text-[#111827] mb-8">
                Discover Your<br />
                <span className="italic text-[#2563EB]">Dream Home</span> with<br />
                AI Intelligence
              </motion.h1>
              ...
              <motion.div variants={itemVariants} className="flex flex-wrap gap-4 mb-10">
                <Link to="/properties" className="bg-[#2563EB] text-white font-manrope font-bold text-lg px-8 py-4 rounded-xl shadow-[0px_10px_15px_-3px_rgba(212,117,91,0.25),0px_4px_6px_-4px_rgba(212,117,91,0.25)] hover:bg-[#1D4ED8] transition-all hover:shadow-xl inline-flex items-center">
                  Explore Properties
                  <span className="font-material-icons text-sm ml-2">arrow_forward</span>
                </Link>
                <Link to="/ai-hub" className="border-2 border-[#d1d5db] text-[#374151] font-manrope font-bold text-lg px-8 py-4 rounded-xl hover:border-[#2563EB] hover:text-[#2563EB] transition-all inline-flex items-center">
                  <span className="font-material-icons text-2xl text-[#2563EB] mr-2">smart_toy</span>
                  ...
                  <div className="absolute bottom-6 left-6 right-6 backdrop-blur-md bg-white/90 border border-white/20 rounded-xl p-4 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1)]">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <p className="font-space-mono text-xs text-[#6b7280] uppercase tracking-wide">Juhu, Mumbai</p>
                      </div>
                      <div className="bg-[rgba(212,117,91,0.1)] px-2 py-1 rounded">
                        <span className="font-manrope font-bold text-xs text-[#2563EB]">AI MATCH: 98%</span>
                      </div>
                    </div>
