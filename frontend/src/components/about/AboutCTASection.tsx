    ...
    <section className="bg-[#1D4ED8] py-24 relative overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-8 text-center relative z-10">
        ...
        <div className="flex gap-4 justify-center">
          <button className="bg-white text-[#1E40AF] font-manrope font-bold text-lg px-10 py-4 rounded-xl shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1)] hover:shadow-2xl transition-all">
            Get Started
          </button>
          <button className="border-2 border-white text-white font-manrope font-bold text-lg px-10 py-4 rounded-xl hover:bg-white hover:text-[#1E40AF] transition-all">
            Schedule a Demo
          </button>
        </div>
      </div>
