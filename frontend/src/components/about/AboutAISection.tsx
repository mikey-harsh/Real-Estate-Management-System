      ...
      <div className="max-w-[1280px] mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            {/* Label */}
            <div className="mb-6">
              <p className="font-space-mono text-xs text-[#2563EB] uppercase tracking-[1.2px]">
                The Engine
              </p>
            </div>
            ...
            <h2 className="mb-6">
              ...
              <span className="font-fraunces font-light italic text-5xl leading-[48px] text-[#2563EB] block">
