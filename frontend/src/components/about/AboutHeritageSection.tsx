      ...
      <div className="max-w-[1280px] mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:pt-16">
            {/* Label */}
            <div className="mb-6">
              <p className="font-space-mono text-xs text-[#2563EB] uppercase tracking-[2.4px]">
                Our Heritage
              </p>
            </div>
            ...
            <h2 className="mb-6">
              ...
              <span className="font-fraunces italic text-[40px] leading-[50px] text-[#2563EB] block">
            ...
            <div className="space-y-6 mb-8">
              <p className="font-manrope font-extralight text-base leading-[26px] text-[#4b5563]">
                Founded by architects and data scientists, Estate Management emerged from a
            ...
            {/* Blockquote */}
            <blockquote className="border-l-4 border-[#2563EB] pl-6 mb-8">
              <p className="font-fraunces italic text-2xl leading-8 text-[#2563EB]">
            ...
            <a 
              href="#team" 
              className="inline-flex items-center gap-2 border-b border-[#221410] pb-1 group hover:border-[#2563EB] transition-colors"
            >
              <span className="font-space-mono text-sm text-[#221410] group-hover:text-[#2563EB] transition-colors">
                Meet the Architects
              </span>

              <ArrowRight className="w-4 h-4 text-[#221410] group-hover:text-[#2563EB] transition-colors" />
            </a>
          </div>
        </div>
      </div>
