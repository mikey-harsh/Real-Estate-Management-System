...
<head>
  ...
  <title>Estate Management API</title>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .ep{display:flex;align-items:center;justify-content:space-between;padding:12px 16px;background:#FAF8F4;border-radius:8px;border-left:3px solid #2563EB;margin-bottom:8px;transition:background .15s}
    ...
    .ftr a{color:#2563EB;text-decoration:none;font-weight:500}
...
<body>
  <div class="dash">
    ...
    <!-- Footer -->
    <div class="ftr">
      <p>&copy; ${new Date().getFullYear()} Estate Management &nbsp;|&nbsp;
        <a href="/health">Health</a> &nbsp;|&nbsp;
        <a href="/status">Status</a> &nbsp;|&nbsp;
        <a href="https://estatemanagement.vercel.app" target="_blank">Website</a>
      </p>
