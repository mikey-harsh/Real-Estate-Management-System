        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/dashboard" className="flex items-center gap-3 group">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="w-9 h-9 bg-[#2563EB] rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-terracotta transition-all duration-300"
            >
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            >
              ...
              <span className="absolute top-1.5 right-1.5 h-2 w-2 bg-[#2563EB] rounded-full" />
            </motion.button>
