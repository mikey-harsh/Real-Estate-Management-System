      ...
      >
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 left-0 w-full h-full"
            style={{
              backgroundImage: `radial-gradient(circle at 25% 25%, #2563EB 0%, transparent 50%), radial-gradient(circle at 75% 75%, #2563EB 0%, transparent 50%)`,
            }}
          />
        </div>

        {/* Decorative circles */}
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-[#2563EB]/10 rounded-full" />
        <div className="absolute -top-12 -left-12 w-64 h-64 bg-[#2563EB]/5 rounded-full" />
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            ...
            <div>
              <div className="text-xl font-bold text-[#FAF8F4]">Estate Management</div>
          ...
          <h1 className="text-4xl font-bold text-[#FAF8F4] leading-tight mb-4">
            Manage Your
            <br />
            <span className="text-[#2563EB]">Real Estate</span>
            <br />
            Portfolio
          </h1>
        ...
        <div className="relative z-10 flex items-center gap-2 text-xs text-[#5A5856]">
          ...
          <span>Secured with 256-bit encryption • Estate Management © 2026</span>
        </div>
      </motion.div>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <div className="text-lg font-bold text-[#1C1B1A]">Estate Management Admin</div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Mail className={cn(
                    ...
                    focusedField === "email" ? "text-[#2563EB]" : "text-[#9CA3AF]"
                  )} />
                </div>
                <input
                  type="email"
                  ...
                  placeholder="admin@estatemanagement.com"
                  className={cn(
                    ...
                    focusedField === "email"
                      ? "border-[#2563EB] ring-3 ring-[#2563EB]/15 shadow-sm"
                      : "border-[#E6D5C3] hover:border-[#2563EB]/50"
                  )}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Lock className={cn(
                    "h-4.5 w-4.5 transition-colors duration-200",
                    focusedField === "password" ? "text-[#2563EB]" : "text-[#9CA3AF]"
                  )} />
                </div>
                <input
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-4 flex items-center text-[#9CA3AF] hover:text-[#2563EB] transition-colors"
                >
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-2.5 bg-[#1C1B1A] hover:bg-[#2563EB] text-[#FAF8F4] py-3.5 px-6 rounded-xl font-semibold text-sm transition-all duration-300 shadow-lg hover:shadow-terracotta disabled:opacity-60 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
                <>
