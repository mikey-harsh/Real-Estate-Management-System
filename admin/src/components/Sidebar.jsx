    ...
    <>
      ...
      >
          ...
          {!isCollapsed ? (
            <Link to="/dashboard" className="flex items-center gap-3 group">
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="w-9 h-9 bg-[#2563EB] rounded-lg flex items-center justify-center shadow-lg"
              >
        ...
        <button
          ...
          className="hidden lg:flex absolute -right-3 top-20 w-6 h-6 bg-[#2563EB] border-2 border-[#1C1B1A] rounded-full items-center justify-center text-white hover:bg-[#C05E44] transition-colors z-10"
        >
          {isCollapsed ? (
                  ...
                  >
                    ...
                    {isActive(item.path) && (
                      <motion.div
                        ...
                        className="absolute inset-0 bg-[#2563EB] rounded-lg"
                        style={{ zIndex: -1 }}
        ...
        <div className="border-t border-white/10 p-4 flex-shrink-0">
          ...
          {!isCollapsed ? (
            <button className="w-full flex items-center gap-3 px-3 py-2.5 mb-2 text-[#9CA3AF] hover:text-[#FAF8F4] hover:bg-white/10 rounded-lg transition-all duration-200 text-sm font-medium">
              ...
              <span className="h-5 w-5 bg-[#2563EB] text-white text-xs flex items-center justify-center rounded-full">
                3
              </span>
            </button>
          ) : (
            <button className="w-full flex items-center justify-center px-3 py-2.5 mb-2 text-[#9CA3AF] hover:text-[#FAF8F4] hover:bg-white/10 rounded-lg transition-all duration-200 relative">
              <Bell className="h-5 w-5" />
              <span className="absolute -top-1 -right-1 h-4 w-4 bg-[#2563EB] text-white text-[10px] flex items-center justify-center rounded-full">
                3
              </span>
            </button>
          )}
          ...
          {!isCollapsed ? (
            <div className="flex items-center gap-3 px-3 py-2.5 mb-2 bg-white/5 rounded-lg">
              <div className="h-9 w-9 bg-[#2563EB] rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex items-center justify-center px-3 py-2.5 mb-2 bg-white/5 rounded-lg">
              <div className="h-9 w-9 bg-[#2563EB] rounded-lg flex items-center justify-center">
                <User className="h-4 w-4 text-white" />
              </div>
            </div>
          )}
