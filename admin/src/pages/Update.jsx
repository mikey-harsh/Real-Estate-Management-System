...
const inputClass = "w-full px-4 py-3 bg-white border border-[#E6D5C3] rounded-xl text-[#1C1B1A] placeholder-[#9CA3AF] text-sm transition-all duration-200 outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/15";
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <button onClick={() => navigate('/list')}
            className="flex items-center gap-2 text-sm text-[#5A5856] hover:text-[#2563EB] mb-4 transition-colors">
        ...
        <motion.form initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
          ...
          <div className="bg-white rounded-2xl p-6 border border-[#E6D5C3] shadow-card">
                  ...
                  <button key={amenity} type="button" onClick={() => handleAmenityToggle(amenity)}
                    className={cn(
                      ...
                      selected
                        ...
                        : 'bg-[#FAF8F4] text-[#5A5856] border border-[#E6D5C3] hover:border-[#2563EB] hover:text-[#2563EB]'
                    )}>
            ...
            <div className="flex gap-2">
              ...
              <button type="button" onClick={handleAddAmenity}
                className="flex items-center gap-1.5 px-4 py-2.5 bg-[#1C1B1A] text-white rounded-xl text-sm font-medium hover:bg-[#2563EB] transition-colors">
            ...
            {formData.amenities.filter((a) => !AMENITIES_LIST.includes(a)).length > 0 && (
              <div className="mt-3 flex flex-wrap gap-2">
                {formData.amenities.filter((a) => !AMENITIES_LIST.includes(a)).map((amenity) => (
                  <span key={amenity}
                    className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#2563EB]/10 text-[#2563EB] rounded-full text-sm font-medium">
                    {amenity}
          ...
          <div className="bg-white rounded-2xl p-6 border border-[#E6D5C3] shadow-card">
            ...
            <label htmlFor="images"
              className="flex flex-col items-center justify-center w-full h-28 border-2 border-dashed border-[#E6D5C3] rounded-xl cursor-pointer bg-[#FAF8F4] hover:border-[#2563EB] hover:bg-[#2563EB]/5 transition-all duration-200 group">
              <Upload className="w-6 h-6 text-[#9CA3AF] group-hover:text-[#2563EB] mb-1.5 transition-colors" />
              <span className="text-sm font-medium text-[#5A5856] group-hover:text-[#2563EB] transition-colors">
                Replace images
              </span>
          ...
          <div className="flex gap-3">
            ...
            <motion.button type="submit" disabled={loading}
              ...
              className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#1C1B1A] hover:bg-[#2563EB] text-[#FAF8F4] rounded-xl font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-terracotta disabled:opacity-60 disabled:cursor-not-allowed">
