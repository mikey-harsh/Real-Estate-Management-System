      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="flex items-center gap-2 px-4 py-2.5 bg-white border border-[#E6D5C3] text-[#1C1B1A] rounded-xl text-sm font-medium hover:border-[#2563EB] hover:text-[#2563EB] transition-all duration-200 shadow-card disabled:opacity-60"
          >
          ...
          <div className="p-6 flex flex-col sm:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 border border-[#E6D5C3] rounded-xl bg-white text-[#1C1B1A] placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/20 focus:border-[#2563EB] transition-all"
              />
            </div>
            <div className="flex gap-3">
              <select
                ...
                className="px-4 py-2.5 border border-[#E6D5C3] rounded-xl bg-white text-[#1C1B1A] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/20 focus:border-[#2563EB] transition-all"
              >
                ...
                <tr>
                  <th className="px-6 py-4 text-left">
                    <input
                      ...
                      className="w-4 h-4 text-[#2563EB] rounded border-[#E6D5C3] focus:ring-[#2563EB]/20"
                    />
                  </th>
