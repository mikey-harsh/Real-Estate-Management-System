                        ...
                        {editingMeetingLink === appointment._id ? (
                          <div className="flex items-center gap-1.5">
                            <input type="url" value={meetingLink}
                              ...
                              className="px-2.5 py-1.5 border border-[#E6D5C3] rounded-lg text-xs w-40 outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB]/20" />
                            <button onClick={() => handleMeetingLinkUpdate(appointment._id)}
                              className="p-1.5 bg-[#2563EB] text-white rounded-lg hover:bg-[#C05E44] transition-colors">
                          ...
                          <div className="flex items-center gap-2">
                            {appointment.meetingLink ? (
                              <a href={appointment.meetingLink} target="_blank" rel="noopener noreferrer"
                                className="flex items-center gap-1 text-xs text-[#2563EB] hover:text-[#C05E44] font-medium underline underline-offset-2">
                            ...
                            {appointment.status === "confirmed" && (
                              <button onClick={() => { setEditingMeetingLink(appointment._id); setMeetingLink(appointment.meetingLink || ""); }}
                                className="p-1 text-[#9CA3AF] hover:text-[#2563EB] transition-colors rounded">
                                <LinkIcon className="w-3.5 h-3.5" />
                              </button>
                            )}
                          </div>
