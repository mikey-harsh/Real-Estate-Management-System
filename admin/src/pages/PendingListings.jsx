        ...
        <div className="flex-1 p-5 flex flex-col gap-3">
          ...
          <div className="flex flex-wrap items-start justify-between gap-2">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <span className="bg-[#F3EDE8] text-[#2563EB] text-xs font-semibold px-2.5 py-1 rounded-full">
                {listing.type}
              </span>
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm text-[#374151]">
            <span className="font-semibold text-[#2563EB] text-base">{formatPrice(listing.price)}</span>
      ...
      {listings.length > 0 && (
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 border border-[#E6E0DA] rounded-xl text-sm text-[#221410] bg-white focus:outline-none focus:ring-2 focus:ring-[#2563EB]/30 focus:border-[#2563EB]"
          />
        </div>
      )}
