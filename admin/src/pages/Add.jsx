    ...
    <div className="min-h-screen pt-8 pb-12 px-4 bg-[#FAF8F4]">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-[#5A5856]">Fill in the details to list a new property on Estate Management</p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-white rounded-2xl p-6 border border-[#E6D5C3] shadow-card">
            ...
            {previewUrls.length < 4 && (
              <label htmlFor="images"
                className="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-[#E6D5C3] rounded-xl cursor-pointer bg-[#FAF8F4] hover:border-[#2563EB] hover:bg-[#2563EB]/5 transition-all duration-200 group">
                <Upload className="w-8 h-8 text-[#9CA3AF] group-hover:text-[#2563EB] mb-2 transition-colors" />
          ...
          <motion.button
            ...
            className="w-full py-4 bg-[#1C1B1A] hover:bg-[#2563EB] text-[#FAF8F4] rounded-xl font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-terracotta disabled:opacity-60 disabled:cursor-not-allowed"
          >
